<!-- Space: Projects -->
<!-- Parent: ZshGoenv -->
<!-- Title: Contributing GithubFlow ZshGoenv -->
<!-- Label: ZshGoenv -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to zsh-goenv project on [GitHub](https://github.com/hadenlabs/zsh-goenv), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/zsh-goenv/pulls).
...
To follow the instructions in this guide and start contributing to zsh-goenv project on GitHub:
